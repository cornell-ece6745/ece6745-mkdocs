...
ECE 6745 Project 2: Accelerator Tape-Out<br>Accelerator RTL Milestone
==========================================================================
...
Consider using the ASIC playground to manually push your accelerator
...
GitHub. The milestone submission is not assessed for a grade and instead
enables the instructors to provide feedback. All of the tests do not need
to be passing, but students must have made meaningful progress towards
their final accelerator RTL implementation. Some child modules should be
implemented and unit tested, and hopefully some basic tests are passing
for the accelerator.
